...
// this must be 1 or higher. The user is then expected to enter integer values.
// The smallest value that the user entered is presented after the user have
// entered the specified number of integer values.
////////////////////////////////////////////////////////////////////////////////
#include <iostream>
#include <limits>
