...
int main()
{
    int factor1{0};    // First integer to multiply storage.
    int factor2{0};    // Second integer to multiply storage.
    int factor3{0};    // Third integer to multiply storage.
    cout << "Enter three integers: ";        // Prompt user for data.
    cin >> factor1 >> factor2 >> factor3;    // Read in data from user.
    
    int product{0};    // The product of the three integers storage.
